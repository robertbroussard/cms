//%attributes = {"publishedWeb":true}
  //G-Method: PrintCPS: Print an envelope for all parties and a letter for all
...
$Style3:=";  in the 314th Judicial Court of Harris County, Texas "
...
$Msg1:=String:C10(Records in set:C195("PrintSet1"))+String:C10(Records in set:C195("PrintSet2")+1)  //Mod RJB 9/3/02

$Msg2:=String:C10(Records in set:C195("AttorneySet1"))+String:C10(Records in set:C195("AttorneySet2"))  //Mod RJB 9/3/02
...
FORM SET OUTPUT:C54([DailyLtrFile:14];"DLFNoticeCPS")  // ALLOWS VARIABLE FRAME PRINT IN CPS  LETTER
