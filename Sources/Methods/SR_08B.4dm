...
CREATE SET:C116([IntakeFile:1];"CaseHrs")  //restrict to UNFILED cases???

INTERSECTION:C121("UnFiledCases";"CaseHrs";"Final")
USE SET:C118("Final")
...
SR_RecDumpLog ("Write";0;$YearMonth;$Filed;$CaseType;"8")
